package com.dev.restart.global.token;

import com.dev.restart.global.env.EnvLoader;
...
public class JwtTokenProvider {
    ...
    public String getUserId(String token){
        ...
        if (!"USER".equals(role)) {
            throw new AccessDeniedException("사용자 전용 API입니다.");
        }
    ...
    public String getCompanyId(String token){
        ...
        if (!"COMPANY".equals(role)) {
            throw new AccessDeniedException("회사 전용 API입니다.");
        }
